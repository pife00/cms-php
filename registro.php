...
if(isset($_POST['nuevoRegistro'])){
    ...
    if(!empty($Usuario) && !empty($Correo) && !empty($Contraseña)){
       ...
       /* $Solicitud = mysqli_query($conexion,"SELECT randSalt FROM usuarios");
        if(!$Solicitud){
        ...
        $querry = mysqli_query($conexion,
        "INSERT INTO usuarios (usuario_sobre_nombre,usuario_contraseña,usuario_correo,usuario_rol)
